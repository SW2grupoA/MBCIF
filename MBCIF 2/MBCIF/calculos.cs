...
class calculos{
     ...
     */
    public Double leerFuncion(String funcion, double valorT, double valorU, double valorV){
        double resultado=0;
        ...
        if(caracter[0]=='('){
            ...
            if(i==caracter.Length)return 0;
                ...
                resultado+=leerFuncion(cadena,valorT,valorU,valorV);
                i++;
            }
        }
        //Si el primer caracter no es un parentesis
            ...
            }else if(caracter[0]=='T'||caracter[0]=='t'){
            ...
            //Si el primer caracter es una l(para logaritmos):
                ...
                if(caracter[i]=='n'){
                    ...
                    if(caracter[i]=='U'||caracter[0]=='u'){
                        cadena=valorU.ToString();
                        i++;
                    }
                    else if(caracter[i]=='T'||caracter[i]=='t'){
                        cadena=valorT.ToString();
                        i++;
                    }
        ...
        Double siguienteElemento=leerFuncion(siguiente,valorT,valorU,valorV);
    ...
    public Double leerFuncion(String funcion, double valorT)
    {
        double resultado = 0;
        char[] caracter = funcion.ToCharArray();
        String cadena = "";
        ...
        if (caracter[0] == '(')
        {
            ...
            {
                resultado += leerFuncion(cadena, valorT);
                i++;
            }
        }
        //Si el primer caracter no es un parentesis
        ...
        String siguiente = "";
        for (int j = i; j < caracter.Length; j++) siguiente += caracter[j];
        Double siguienteElemento = leerFuncion(siguiente, valorT);
